...
![image.png](Step%208%20-%20Splunk%20Setup/image.png)

And execute this downloaded .msi file.

![image.png](Step%208%20-%20Splunk%20Setup/image%201.png)
...
![image.png](Step%208%20-%20Splunk%20Setup/image%202.png)
...
![image.png](Step%208%20-%20Splunk%20Setup/image%203.png)

![image.png](Step%208%20-%20Splunk%20Setup/image%204.png)

![image.png](Step%208%20-%20Splunk%20Setup/image%205.png)

![image.png](Step%208%20-%20Splunk%20Setup/image%206.png)

Now i need to create an index to store logs.

Settings → Indexes → “New Index”

![image.png](Step%208%20-%20Splunk%20Setup/image%207.png)

![image.png](Step%208%20-%20Splunk%20Setup/image%208.png)

![image.png](Step%208%20-%20Splunk%20Setup/image%209.png)
